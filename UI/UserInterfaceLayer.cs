...
//namespace SEGame.UI
//{
//    internal class UserInterfaceLayer : IUpdate, IDrawable
//    {
...
//                    if (e.GetClickableArea().Contains(mouseState.Position) && InputManager.GetInstance().IsJustPressed(Input.MouseButtons.Left))
//                        e.OnClick();
//                }
...
//                    {
//                        var mouseState = Mouse.GetState();
//                        var left = InputManager.GetInstance().IsJustPressed(Input.MouseButtons.Left);
